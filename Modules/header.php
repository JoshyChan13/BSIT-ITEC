...
<body>
    <header>
        <div class="logo"><a href=""><img src="img/logo.png" style="width: 110px;"></a></div>
        <nav>
            <ul>
                <li><!-- From Uiverse.io by andrei0x309 --> 
                <div class="input">
                    <button class="value" onclick="location.href='home.php'">
                    ...
                    <button class="value" onclick="location.href='menu.php'">
                        <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="5 2 14 25">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 4h3a1 1 0 0 1 1 1v15a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1V5a1 1 0 0 1 1-1h3m0 3h6m-6 5h6m-6 4h6M10 3v4h4V3h-4Z"/>
                        </svg>
                        Menu
                    </button>
                    <button class="value" onclick="location.href='Celebration.php'">
                        <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 10h16m-8-3V4M7 7V4m10 3V4M5 20h14a1 1 0 0 0 1-1V7a1 1 0 0 0-1-1H5a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1Zm3-7h.01v.01H8V13Zm4 0h.01v.01H12V13Zm4 0h.01v.01H16V13Zm-8 4h.01v.01H8V17Zm4 0h.01v.01H12V17Zm4 0h.01v.01H16V17Z"/>
                        </svg>
                        Reservation
                    </button>
                    <button class="value" onclick="location.href='Contact.php'">
                        <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                    ...
                    <button class="value" onclick="location.href='Profile.php'">
                    <svg
                        class="icon"
                        stroke="currentColor"
                        fill="currentColor"
